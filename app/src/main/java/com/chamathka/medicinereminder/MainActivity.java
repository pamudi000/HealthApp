    ...
    private List<MedicineModel> getData() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                mn.setId(cursor.getString(cursor.getColumnIndex(MedicineModel.COLUMN_ID)));
...
//list length
        ...
        if(mn.isEmpty()){
            ...
            for (MedicineModel model : mn) {
                ...
                if (model.getMedicineType().equals("Liquid")) {
    ...
    private void initRecyclerView() {
        ...
        RecycleAdapter adapter = new RecycleAdapter(this,medicineId,imageId,medicineName,medicineDosage,medicineType,medicineTime);
